...
import br.com.fiap.ms.pagamento.service.PagamentoService;
...
public class PagamentoControllerTest {
    ...
    void deleteShouldReturn404WhenIdDoesNotExist() throws Exception {
        ...
        Mockito.doThrow(ResourceNotFoundException.class).when(pagamentoService).deletePagamentoById(nonExistingId);
